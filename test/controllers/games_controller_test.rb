...
class GamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update game" do
    patch game_url(@game), params: { game: { description: @game.description, image_url: @game.image_url, price: @game.price, release_date: @game.release_date, title: @game.title } }
